 ...
 * | Tab  |   A  |   S  |   D  |   F  |   G  |   H  |   J  |   K  |   L  |   ;  |  '   |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * | F8   |   Z  |   X  |   C  |   V  |   B  |   B  |   M  |   ,  |   .  |   /  |Enter |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |   F9 |  ALT | Lower|Space |  F7  |Space |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_GAMING] = LAYOUT_ortho_4x12( \
  ...
  KC_LCTRL,KC_F9,   KC_LALT, KC_F6,   KC_SPC,  KC_F7,   KC_SPC,  UP_HYP,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
),
...
[_RAISE] = LAYOUT_ortho_4x12( \
  ...
  DF(0),   DF(1),   DF(2),   _______, _______, _______, _______, _______, KC_HOME, KC_VOLD, KC_VOLU, KC_END \
),
